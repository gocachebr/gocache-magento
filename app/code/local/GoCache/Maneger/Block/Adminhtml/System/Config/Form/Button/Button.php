<?php
class GoCache_Maneger_Block_Adminhtml_System_Config_Form_Button_Button 
    ...
    extends Mage_Adminhtml_Block_System_Config_Form_Field implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    {
        parent::_construct();
        $this->setTemplate('GoCache/maneger/system/config/button/button.phtml');
    }
    ...
    {
        $mododeveloper = Mage::getStoreConfig('maneger/config/mododeveloper');
        if($mododeveloper == 1){
